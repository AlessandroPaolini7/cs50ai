...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    """
    # Initializing joint probability
    joint_probability = 1
    ...
    for person in people:
        ...
        # If person has parents, use conditional probability
        else:
            ...
            if gene_number == 0:
                joint_probability *= (1 - mother_probability) * (1 - father_probability)
            elif gene_number == 1:
                joint_probability *= mother_probability * (1 - father_probability) + father_probability * (1 - mother_probability)
            else:
                joint_probability *= mother_probability * father_probability
            joint_probability *= PROBS["trait"][gene_number][trait]
